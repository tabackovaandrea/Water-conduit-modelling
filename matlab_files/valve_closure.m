...
% Podmínka komín K3
 ...
 % Podmínka ventil napravo - ZAVÍRÁNÍ 
         if time<t_start
         ...
         elseif time<t_start+t_trvani
           ...
           koef_zavirani = 1 - (time - t_start) / t_trvani;
           Q(j+1, N_pol+N8+N9+N10+N11+N12+N13) = Q_start * koef_zavirani;
...
%vidObj = VideoWriter('Valve_closure','MPEG-4');
